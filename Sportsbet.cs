    ...
    internal class Sportsbet
    {
        ...
        public async Task<string> ScrapeData()
        {
            try
            {
                ...
                string message = $"**Alert**: Prices detected for game between **{team1Name} and {team2Name}** on **{standardizedDate}** at **{standardizedTime}**. Odds are **{priceTeam1}** for {team1Name}, **{priceTeam2}** for {team2Name}.";
